...
// CHECK-NEXT:    [[TMP1:%.*]] = load volatile <16 x i8>, ptr @vuc1, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP6:%.*]] = load volatile <16 x i8>, ptr @vuc1, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP12:%.*]] = load volatile <16 x i8>, ptr @vuc1, align 8, !tbaa [[CHAR_TBAA3]]
// CHECK-NEXT:    [[TMP13:%.*]] = load volatile <16 x i8>, ptr @vuc2, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP20:%.*]] = load volatile <16 x i8>, ptr @vuc1, align 8, !tbaa [[CHAR_TBAA3]]
// CHECK-NEXT:    [[TMP21:%.*]] = load volatile <16 x i8>, ptr @vuc2, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP28:%.*]] = load volatile <16 x i8>, ptr @vuc1, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP33:%.*]] = load volatile <16 x i8>, ptr @vuc1, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP39:%.*]] = load volatile <16 x i8>, ptr @vuc1, align 8, !tbaa [[CHAR_TBAA3]]
// CHECK-NEXT:    [[TMP40:%.*]] = load volatile <16 x i8>, ptr @vuc2, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP47:%.*]] = load volatile <16 x i8>, ptr @vuc1, align 8, !tbaa [[CHAR_TBAA3]]
// CHECK-NEXT:    [[TMP48:%.*]] = load volatile <16 x i8>, ptr @vuc2, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP55:%.*]] = load volatile <4 x i32>, ptr @vui1, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP59:%.*]] = load volatile <2 x i64>, ptr @vul1, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP63:%.*]] = load volatile <2 x i64>, ptr @vul1, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP67:%.*]] = load volatile <2 x i64>, ptr @vul1, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP73:%.*]] = load volatile <2 x i64>, ptr @vul1, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP79:%.*]] = load volatile <2 x i64>, ptr @vul1, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP85:%.*]] = load volatile <2 x i64>, ptr @vul1, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP91:%.*]] = load volatile <2 x i64>, ptr @vul1, align 8, !tbaa [[CHAR_TBAA3]]
...
// CHECK-NEXT:    [[TMP97:%.*]] = load volatile <16 x i8>, ptr @vuc1, align 8, !tbaa [[CHAR_TBAA3]]
